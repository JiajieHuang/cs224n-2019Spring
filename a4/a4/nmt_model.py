...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        self.decoder=nn.LSTMCell(input_size=2*hidden_size,hidden_size=embed_size)
        ...
        self.target_vocab_projection=nn.Linear(in_features=embed_size, out_features=len(vocab.tgt),bias=False)
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[torch.Tensor, Tuple[torch.Tensor, torch.Tensor]]:
        ...
        X=pack_padded_sequence(X,lengths=source_lengths,batch_first=True)
        enc_hiddens,hc=self.encoder(X)
